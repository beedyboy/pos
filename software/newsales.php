...
<!--
<li class="bd-tab-link"> <a href="#" id="S"  class="beedytablinks"> 
...
-->
	...
	while( $sub = $subCategory->fetch()){ 
	?>



<button class="accordion"> <?php echo System::getColById('subcategory', 'subId',$sub['subId'], 2); ?></button>
<div class="panel">
   <?php  $cResult =   System::loadAllProductsWhere($sub['subId']);    
 ...
 $lsubCategory = System::loadDistinctWhere('subId',  'products', 'main', 'L');

	while( $lsub = $lsubCategory->fetch()){ 
	?> 

       <button class="accordion"> <?php echo System::getColById('subcategory', 'subId',$lsub['subId'], 2); ?></button>
<div class="panel">
   <?php  $lResult =   System::loadAllProductsWhere($lsub['subId']);    
   while( $lRow = $lResult->fetch()){
    ?>

 <button class="meal-button addLocalMeal" cid="L" id="<?php echo $lRow['product_id'];?>"
  name=" <?php echo $lRow['product_name']; ?>"> <?php echo $lRow['product_name']; ?>
	<br />
	<?php echo $cRow['price']; ?>
	</button> 
 ...
 $ssubCategory = System::loadDistinctWhere('subId',  'products', 'main', 'S');

	while( $ssub = $ssubCategory->fetch()){ 

	?>

       <button class="accordion"> <?php echo System::getColById('subcategory', 'subId',$ssub['subId'], 2); ?></button>
<div class="panel">
<?php
	$sResult =   System::loadAllProductsWhere($ssub['subId']); 
 ...
 $dsubCategory = System::loadDistinctWhere('subId',  'products', 'main', 'D');

	while( $dsub = $dsubCategory->fetch()){ 

	?>

       <button class="accordion"> <?php echo System::getColById('subcategory', 'subId',$dsub['subId'], 2); ?></button>
<div class="panel">
<?php


	$bResult =   System::loadAllProductsWhere($dsub['subId']); 
...
echo "</div>";
 ...
 $fsubCategory = System::loadDistinctWhere('subId',  'products', 'main', 'F');

	while( $fsub = $fsubCategory->fetch()){ 

	?>

       <button class="accordion"> <?php echo System::getColById('subcategory', 'subId',$fsub['subId'], 2); ?></button>
<div class="panel">
<?php
	$fResult =   System::loadAllProductsWhere($fsub['subId']); 
